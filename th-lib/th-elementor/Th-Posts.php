...
class Th_Posts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts', 'construction' );
	}
	...
	public function get_thumb_default_animation($key='thumb_default_animation', $class="") {
		$this->add_control(
			$key,
			[
				'label' 	=> esc_html__( 'Thumbnail default animation', 'construction' ),
				'type'      => Controls_Manager::SELECT,
				'description' => esc_html__( 'Item style apply for Grid or Slider', 'construction' ),
				'default'   => 'style1',
				'options'   => [
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-post-grid'			=> esc_html__( 'Grid', 'construction' ),
					'elth-post-slider'			=> esc_html__( 'Slider', 'construction' ),
					'elth-post-grid-layout1'	=> esc_html__( 'Grid - layout 1', 'construction' ),
				],
			]
		);
		...
		$this->add_control(
			'type_active',
			[
				'label' 	=> esc_html__( 'Active type', 'construction' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'grid',
				'options'   => [
		...
		$this->add_group_control(
			...
			[
				...
				'default' => 'large',
				'separator' => 'none',
				'description' => esc_html__( 'Apply for Grid  style active grid or Slider', 'construction' ),
			]
		);
		...
		$this->add_control(
			'item_meta',
			[
				'label' => esc_html__( 'Meta data', 'construction' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'construction' ),
				'label_off' => esc_html__( 'Off', 'construction' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_meta_select',
			[
				'label' 	=> esc_html__( 'Meta', 'construction' ),
				'type'      => Controls_Manager::SELECT2,
				'default'   => '',
				'options'   => [
					'author'	=> esc_html__( 'Author', 'construction' ),
					'date'		=> esc_html__( 'Date', 'construction' ),
					'cats'		=> esc_html__( 'Categories', 'construction' ),
					'tags'		=> esc_html__( 'Tags', 'construction' ),
					'comments'	=> esc_html__( 'Comments', 'construction' ),
					'views'		=> esc_html__( 'Total views', 'construction' ),
				],
				'multiple'	=> true,
				'condition' => [
					'item_meta' => 'yes',
		...
		$this->add_control(
			'item_excerpt',
			[
				'label' => esc_html__( 'Excerpt', 'construction' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'construction' ),
				'label_off' => esc_html__( 'Off', 'construction' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_list_style',
			[
				'label' 	=> esc_html__( 'Item list style', 'construction' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Style 1 - default', 'construction' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Thumbnail Width', 'construction' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' , 'px' ],
				'range' => [
					'%' => [
		...
		$this->add_control(
			'excerpt_list',
			[
				'label' => esc_html__( 'Excerpt list', 'construction' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 500,
				'step' => 1,
		...
		$this->add_responsive_control(
			'meta_space',
			[
				'label' => esc_html__( 'Space meta item', 'construction' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_responsive_control(
			'meta_icon_space',
			[
				'label' => esc_html__( 'Space icon', 'construction' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
