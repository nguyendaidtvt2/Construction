...
class Th_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products', 'construction' );
	}
	...
	public function get_slider_styles() {
		...
		$this->add_control(
			'navigation_on_hover',
			[
				'label' => esc_html__( 'Display on hover', 'construction' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'construction' ),
				'label_off' => esc_html__( 'Off', 'construction' ),
				'return_value' => 'yes',
	...
	protected function register_controls() {
		...
		$this->add_control(
			'display',
			[
				'label' 	=> esc_html__( 'Display type (Layout)', 'construction' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'elth-product-grid',
				'options'   => [
					'elth-product-grid'		=> esc_html__( 'Grid', 'construction' ),
					'elth-product-slider'		=> esc_html__( 'Slider', 'construction' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'style1',
				'options'   => [
					''		=> esc_html__( 'Style 1 - default', 'construction' ),
					...
					'style7'		=> esc_html__( 'Style 7 (table)', 'construction' ),
				],
			]
		);
		...
		$this->add_control(
			'display_tab',
			[
				'label' => esc_html__( 'Display tab', 'construction' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'construction' ),
				'label_off' => esc_html__( 'Off', 'construction' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'product_type',
			[
				'label' 	=> esc_html__( 'Product type', 'construction' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					'' 				=> esc_html__('Default','construction'),
                    'trending' 		=> esc_html__('Trending','construction'),
                    'featured' 		=> esc_html__('Featured Products','construction'),
                    'bestsell' 		=> esc_html__('Best Sellers','construction'),
                    'onsale' 		=> esc_html__('On Sale','construction'),
                    'toprate' 		=> esc_html__('Top rate','construction'),
                    'mostview' 		=> esc_html__('Most view','construction'),
		...
		$this->add_control(
			'custom_ids', 
			[
				'label' => esc_html__( 'Show by IDs', 'construction' ),
				'description' => esc_html__( 'Enter IDs list. The values separated by ",". Example 11,12', 'construction' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '11,12', 'construction' ),
			]
		);
		...
		$this->add_control(
			'pagination',
			[
				'label' 	=> esc_html__( 'Grid pagination', 'construction' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''				=> esc_html__( 'None', 'construction' ),
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Filter', 'construction' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'section_tab',
			[
				'label' => esc_html__( 'Tab', 'construction' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display_tab' => 'yes',
				]
		...
		$repeater->add_control(
			'title', [
				'label' => esc_html__( 'Title', 'construction' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab Title' , 'construction' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Add tab', 'construction' ),
		...
		$this->add_responsive_control(
			'tab_item_width',
			[
				'label' => esc_html__( 'Item width', 'construction' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'tab_item_height',
			[
				'label' => esc_html__( 'Item height', 'construction' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Load more button', 'construction' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
	...
	protected function render() {
		...
		if ( $view == 'slider' ) {
			$this->add_render_attribute( 'elth-wrapper', 'class', 'elth-swiper-slider swiper-container navigation-hover-'.$navigation_on_hover );
