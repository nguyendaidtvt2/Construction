...
class Th_Image_Choose extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_register_style( 'elementskit-css-image-choose-control',  th_Elementor::get_url_css() . 'imagechoose.css', [], '1.0.0' );
		wp_enqueue_style( 'elementskit-css-image-choose-control' );

		// script
		wp_register_script( 'elementskit-js-image-choose-control',  th_Elementor::get_url_js() . 'imagechoose.js' );
