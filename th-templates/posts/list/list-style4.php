<?php
if(empty($size_list)) $size_list = array(300,300);
if(!isset($excerpt_list)) $excerpt_list = 0;
$thumb_class = 'col-md-3 col-sm-4 col-xs-12';
$info_class = 'col-md-9 col-sm-8 col-xs-12';
if(!has_post_thumbnail()) $thumb_class = $info_class = 'col-md-12 col-sm-12 col-xs-12';
global $post;
?>
<div class="col-md-12 col-sm-12 col-xs-12 item-post-wrap">
    <div class="item-post item-post-list item-style4">
        <div class="row">
