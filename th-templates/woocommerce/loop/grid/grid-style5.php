...
<?php if(isset($column) && $view == 'grid') echo '<div '.$item_wrap.'>';?>
	<?php echo '<div '.$item_inner.'>';?>
		<div class="item-product item-product-grid item-product-grid-style4 item-product-grid-style5 icon">
			...
			<?php if($item_thumbnail == 'yes' && has_post_thumbnail()):?>
				<div class="product-thumb">
					...
					<div class="thumb-extra-link icon-small style3"> <!-- "",style2,style3,style4 -->
