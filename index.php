    ...
    <div class="container">
        <div class="row">
            ...
            <div class="<?php echo esc_attr(th_get_main_class()); ?>">
                ...
                $column         = th_get_option('post_grid_column',2);
                ...
                $show_title     = th_get_option('blog_title');
                $item_excerpt     = th_get_option('blog_des');
                $item_button     = th_get_option('blog_read_more');
                ...
                $item_inner = 'class="item-post item-post-style1"';
                ...
                if($type_active == 'list') $item_meta_select = $item_meta_select = ['author','date','comments'];
                ...
                th_get_template('top-filter','',array(
                    'style'=>$type_active,
                    'number'=>$number,
                ...
                <div class="js-content-wrap elth-posts-wrap <?php echo esc_attr($el_class)?>" data-column="<?php echo esc_attr($column)?>">
    				...
    				<?php else : ?>
    				    ...
    				    <?php echo th_get_template_post( 'content' , 'none' ); ?>
